...
var SubMenu = function (_a) {
    ...
    var _b = useState(isOpend), open = _b[0], setOpen = _b[1];
    ...
    var renderChildren = function () {
        ...
        return (React.createElement(Transition, { in: open, timeout: 5200, animation: "zoom-in-bottom" },
    ...
    return (React.createElement("li", __assign({ className: classes }, hoverEvents),
        React.createElement("div", __assign({ className: "submenu-title" }, clickEvents),
            title,
            React.createElement(Icon, { theme: "primary", icon: "angle-down", className: "arrow-icon" })),
        renderChildren()));
};
